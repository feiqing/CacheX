...
public class CacheXDIContainer {
    ...
    private static void savePackageBeanInstance(Set<Class<?>> classes, Class<?> rootBeanClass, Object rootBean) {
        ...
        CacheXDIContainer.nameBeanMap.putAll(nameBeanMap);
        CacheXDIContainer.classBeanMap.putAll(classBeanMap);
    }
                ...
                .forEach((field) -> {
                    ...
                    if (bean == null) {
                        if (inject.optional()) {
                            ...
                            throw new CacheXException("field " + field.getDeclaringClass().getName()
