...
public class SerializeUtils {
    ...
    public static Map<byte[], byte[]> toByteMap(Map<String, Object> keyValues, ISerializer serializer) {
    ...
    public static List<Map<byte[], byte[]>> toByteMap(Map<String, Object> keyValues, ISerializer serializer, int limit) {
